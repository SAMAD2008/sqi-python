data = [
    {
        ...
        "sourceUrls": ["https://en.wiktionary.org/wiki/draw"],
    }
]
...
# Example4: .....
Example4 = data[0]["meanings"][0]["definitions"][3].get("example")
print(Example4)
